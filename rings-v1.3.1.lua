...
+ v1.0 -- Original release (28.09.2009)
        ...
        arg=conky_parse("${if_up wlan0}wlan0${else}enp5s0${endif}"),
        fg_colour=0xf0651f,
        fg_colour=conky_parse("${if_up wlan0}wlan0${else}enp5s0${endif}"),
        conky_parse("${cpu}")
...
settings_table = {
    ...
    {
        name='execi',
        arg='5 nvidia-settings -q [gpu:0]/UsedDedicatedGPUMemory -t',
        max=4000,
        bg_colour=0x000000,
        bg_alpha=0.8,
        fg_colour=0x1faaf0,
    ...
    {
        name='execi',
        arg='5 nvidia-settings -q [fan:0]/GPUCurrentFanSpeed -t',
        max=100,
        bg_colour=0x000000,
        bg_alpha=0.4,
        fg_colour=0x1faaf0,
...
function iface_watch()
    ...
    iface=conky_parse("${if_existing /proc/net/route enp5s0}enp5s0${else}wlan0${endif}")
